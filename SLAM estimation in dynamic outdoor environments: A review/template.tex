...
\title{\citetitle{lu_slam_2009}} % Article title
\author{%
...
\begin{abstract}
\noindent This paper gives a review of SLAM algorithms in 2009. They have reviewed few Monocular, Stereovision, Lidar dedicated algorithms
\end{abstract}
}
